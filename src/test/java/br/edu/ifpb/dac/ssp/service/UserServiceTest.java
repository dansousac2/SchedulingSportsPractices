...
class UserServiceTest {
	...
	public void findByRegistrationValid() { // registration valid
		...
		assertDoesNotThrow(() -> service.findByRegistration((long) 20201502));
		verify(repository).findByRegistration((long) 20201502);
	}
	...
	public void findByRegistrationInvalidNotFound() { // registration invalid because is not found in DB
		...
		Throwable exc = assertThrows(ObjectNotFoundException.class, () -> service.findByRegistration((long) 123456789));
	...
	public void saveValid() { // save valid
		exUser.setName("M@ry");
		exUser.setRegistration((long) 159357);
	...
	public void updateValid() { // update valid 
		try {
			exUser.setName("John");
			exUser.setId(1);
			exUser.setRegistration((long) 13579);
	...
	public void updateInvalidIdNotMatch() { // update invalid because User's id not match with the id of User on DB
		...
		exUser.setRegistration((long) 123123); // pertence to object B in DB
		
		User otherUser = new User();
		otherUser.setId(2);
		otherUser.setName("Robbie Williams"); //object B in DB
		otherUser.setRegistration((long) 123123);
